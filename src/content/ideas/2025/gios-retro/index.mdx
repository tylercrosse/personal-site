...
status: 'complete'
type: 'retro'
tags: ['GIOS', 'operating-systems', 'c', 'c++', 'multithreading', 'IPC', 'socket-programming', 'distributed-systems', 'computer-science', 'learning-in-public', 'MSCS']
category: ['mscs']
draft: false
audience: 'All'
...
import osOverview from "./os-overview2.png";
...
- **Project 4:** [GRPC and Distributed Systems](/ideas/2025/gios-pr4/)
