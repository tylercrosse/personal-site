...
> [!note]
> I keep this post focused on the core ideas behind Project 5. For the broader course overview, see: [GPU Hardware and Software: A Retrospective](/ideas/2025/gpu-retro/).
