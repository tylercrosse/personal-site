...
status: 'draft'
type: 'retro'
tags: ['HDDA', 'machine-learning', 'python', 'computer-science', 'MSCS', 'learning-in-public']
category: ['mscs']
draft: true
audience: 'All'
media_subpath: "/ideas/hdda-overview/"
image:
...
import statisticalLearning from "../../../books/statistical-learning.jpg";
...
import imageProcessingCpp from "../../../books/image-processing-c++.jpg";
import computerVision from "../../../books/computer-vision-szeliski.jpg";
import convexOptimization from "../../../books/convex-optimization.jpg"
...
<BookCard
  ...
  img={statisticalLearning}
  url="https://www.statlearning.com/"
>
  <p>
    A classic textbook on statistical learning.
  </p>
</BookCard>
...
<BookCard
  ...
  url="https://www.amazon.com/Elementary-Linear-Algebra-10th-Howard/dp/0470432055"
>
  <p>
...
<BookCard
  ...
  img={imageProcessingCpp}
  url="https://www.amazon.com/Image-Processing-C-Richard-Szeliski/dp/0262134489"
>
  <p>
    A classic textbook on image processing.
  </p>
</BookCard>
...
<BookCard
  ...
  author="Richard Szeliski"
  img={computerVision}
  url="https://www.amazon.com/Computer-Vision-Principles-Algorithms-Problem/dp/0262044420"
>
  <p>
    A classic textbook on computer vision.
  </p>
</BookCard>
...
<BookCard
  ...
  img={convexOptimization}
  url="https://www.amazon.com/Convex-Optimization-Boyd-Stephen/dp/0521833787"
>
  <p>
    A classic textbook on convex optimization.
  </p>
</BookCard>