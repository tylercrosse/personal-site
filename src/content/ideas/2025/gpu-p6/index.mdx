...
>
  <p>
    The original FlashAttention paper (NeurIPS 2022). Section 3 derives the online softmax algorithm and the tiling scheme from first principles. Reading this before implementing is essential, because it explains *why* the algorithm works, not just the mechanics.
  </p>
</BookCard>
