...
The top research themes this year? Not a surprise:
	- LLMs dominated, with the most papers in the bucket of "deep learning: large language models". 
	- Followed by computer vision, generative modeling, graph neural nets, and interpretability.
...
Notes to future me
  ...
  - It's okay to reach out to researchers. Often this is how jobs PhD programs are found.
