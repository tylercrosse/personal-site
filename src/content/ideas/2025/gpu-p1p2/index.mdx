...
> [!note]
> I keep this write-up centered on the concepts and design tradeoffs behind Projects 1 and 2. For the full course arc, see the companion post: [GPU Hardware and Software: A Retrospective](/ideas/2025/gpu-retro/).
