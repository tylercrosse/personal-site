...
status: 'complete'
type: 'note'
tags: ['digital-gardens', 'learning-in-public']
media_subpath: '/ideas/planting-seeds/'
category: ['seedling']
hero:
    alt: 'Flowers Harmony by tubik.arts'
    src: './garden.webp'
draft: false
audience: 'All'
image:
  path: './jungles-of-henri-rousseau.jpg'
  alt: Jungle by Henri Rousseau
---
