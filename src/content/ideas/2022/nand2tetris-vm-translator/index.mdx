...
media_subpath: '/ideas/nand2tetris-vm-translator/'
parent: '2022/nand2tetris'
hero:
    alt: 'Self Replicating Machine by Peter J. Yost'
    src: 'self-replicating-machine.png'
draft: false
audience: 'All'
image:
  path: "./self-replicating-machine.png"
  alt: Self Replicating Machine by Peter J. Yost
---
