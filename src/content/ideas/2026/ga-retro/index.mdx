...
- **Status**: Parts 1 and 2 are documented. Part 3 is in progress.
...
2. **Part 2 — Graphs + RSA / Cryptography**: Graph algorithms (BFS, DFS, shortest paths, MSTs, max-flow) and an introduction to number-theoretic cryptography. The graph portion especially pushes the course toward reductions and structural reasoning.
...
- **[Part 2: Graphs](/ideas/2026/ga-2/)** — A concept guide to graph algorithms through the black-box lens: traversal, shortest paths, cuts, and reductions.
