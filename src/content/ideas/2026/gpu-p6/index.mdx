...
status: 'complete'
type: 'project'
tags: ['GPU', 'CUDA', 'c++', 'python', 'pyTorch', 'computer-architecture', 'machine-learning', 'deep-learning', 'large-language-models', 'MSCS']
category: ['projects']
draft: false
audience: 'Technical'
...
> [!note]
> I keep this write-up focused on the implementation ideas behind the capstone project. For the broader course overview, see: [GPU Hardware and Software: A Retrospective](/ideas/2026/gpu-retro/).
...
Both use the tiled GEMM pattern from Project 1 (see [The Tiling Solution](/ideas/2026/gpu-p1p2/#the-tiling-solution)). The attention-specific twist is handling both GEMM_NN and GEMM_NT layouts while keeping shared-memory accesses efficient.
