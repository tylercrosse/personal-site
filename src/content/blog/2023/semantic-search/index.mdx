...
image:
  path: "./the-ascendants-by-wangari-mathenge.webp"
  alt: 'The Ascendants XI (Homage To Ecclesiastes 3:1-8), 2021 by Wangari Mathenge'
---
...
![Comparision of representations between one hot encoding and word embeddings. From WhatsNextApp: LSTM-based Next-App Prediction with App Usage Sequences](Comparison-of-representations-between-one-hot-encoding-and-word-embeddings.png)

![PLACEHOLDER https://neuro.cs.ut.ee/wp-content/uploads/2018/09/embeddings.png](embeddings.png)
