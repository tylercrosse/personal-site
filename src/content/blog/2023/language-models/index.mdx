...
status: 'complete'
type: 'article'
tags: ['machine-learning', 'data-science', 'short', 'nlp']
category: ['seedling']
media_subpath: '/ideas/language-models/'
draft: false
audience: 'All'
image:
  path: "./statistical-modeling.jpg"
  alt: Statistical Modeling by D.P. Kroese and J.C.C. Chan. Statistical Modeling and Computation,
    Springer, 2014.
---

import { Image } from "astro:assets";

import googleAutocomplete from "./google-autocomplete-screenshot.png";
import fairDice from "./fair_dice.webp";
import iSawACatProb from "./i_saw_a_cat_prob.gif";
import generationExample from "./generation_example.mp4";
import iphonePredictiveText from "./iphone-predictive-text-dave-smith-bi.webp";
import modelSizeOverTime from "./model-size-over-time2.png";
...
<div style="max-width: 500px; margin: 0 auto;">
  <Image src={googleAutocomplete} alt="Google Autocomplete by Google" />
</div>
...
<div style="max-width: 500px; margin: 0 auto;">
  <Image src={fairDice} alt="Probabilties of dice" />
</div>
...
<div style="padding: 30px 0; margin: 0 auto;">
  <Image src={iSawACatProb} alt="N-gram probability by Lena Voita" />
</div>
...
<div style="padding: 30px 0; margin: 0 auto;">
  <video src={generationExample} loop autoplay muted />
</div>

And with some relatively simple math, voila! You have a language model that can be used for real-world problems. 

<div style="max-width: 360px; margin: 0 auto;">
  <Image src={iphonePredictiveText} alt="Predictive Text by Dave Smith for Business Insider" />
</div>
...
<div style="max-width: 860px; margin: 0 auto;">
  <Image src={modelSizeOverTime} alt="Model Size Over Time" />
</div>
