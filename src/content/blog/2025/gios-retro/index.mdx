...
import addressTranslation from "./address-translation3.png";
import multiLevelPageTables from "./multi-level-page-tables.png";
import BookCard from "../../../../components/BookCard.astro";
import osTepImg from "./os-tep.jpg";
import csAppImg from "./cs-app.jpg";
import cLangImg from "./c-lang.jpg";
import beejGuidesImg from "./beej-network.jpg";
import linuxInterfaceImg from "./linux-interface.png";
...
<div style="max-width: 420px; margin: 0 auto;">
  <Image src={multiLevelPageTables} alt="Multi-Level Page Tables" />
</div>
...
{/* TODO add diagram of virtualization? */}
...
*   **Platform as a Service (PaaS)**: Provides a platform for developers to build and deploy applications without worrying about the underlying infrastructure. The provider manages the OS, runtime, and middleware. (e.g., Heroku, Google App Engine).
...
I'm planning to include follow up posts on each of the projects in the future and will update this post with links to them.

### Grading

Here's the grading breakdown from when I took the course in Spring 2024:

- 5% Participation (views and posts in the discussion forum)
- 15% Project 1 - Multi-threaded Web Server
- 15% Project 3 - Cache & Proxy Servers with Shared Memory IPC
- 15% Project 4 - GRPC and Distributed Systems
- 25% Midterm Exam - Everything up to Memory, Persistence, & I/O
- 25% Final Exam - Everything after that

The course was graded on a slight curve. A ton of folks withdrew (38.1%), so the [grade distribution](https://lite.gatech.edu/lite_script/dashboards/grade_distribution.html) for the ones that ones that stayed was pretty good. It was as follows:
- A: 39.1%
- B: 16.5%
- C: 3.6%
- D: 1.2%
...
<BookCard
  ...
  img={cLangImg}
  url="https://www.google.com/books/edition/The_C_Programming_Language/OpJ_0zpF7jIC?hl=en&gbpv=1&dq=the+c+programming+language&printsec=frontcover"
>
    <p>
...
- An Introduction to Programming with Threads [@birrell1989introduction]
- Beyond Multiprocessing: Multithreading the SunOS Kernel [@eykholt1992beyond]
- Implementing Lightweight Threads [@stein1992implementing]
- Flash: An Efficient and Portable Web Server [@pai1999flash]
- The Performance of Spin Lock Alternatives for Shared-Memory Multiprocessors [@anderson1990performance]
- Formal Requirements for Virtualizable Third Generation Architectures [@popek1974formal]
- Virtual Machine Monitors: Current Technology and Future Trends [@rosenblum2005virtual]
- Implementing Remote Procedure Calls [@birrell1984implementing]
- Caching in the Sprite Network File System [@nelson1988caching]
- Distributed Shared Memory: Concepts and Systems [@protic1996distributed]

## My Experience

GIOS was the first course I took for the program and it was a great way to get my feet wet. The projects were difficult but meaningful, and the concepts challenged me to think at a systems level, below the abstraction layers I'm usually working in. While I still have much to learn, this course pushed me toward the kind of engineer I want to become.
