...
Books:
- Operating Systems: Three Easy Pieces [@arpaci-dusseauOperatingSystemsThree2018]
- Computer Systems: A Programmer's Perspective [@bryant2011computer]
- The C Programming Language [@kernighan1988c]
- Beej's Guide to C Programming [@hallBeejsGuideProgramming2024]
- Beej's Guide to Network Concepts [@hallBeejsGuideNetwork2024]
- Beej's Guide to Unix IPC [@hallBeejsGuideInterprocess2024]
- Beej's Guide to Network Programming [@hallBeejsGuideNetwork2019]
- The Linux Programming Interface: A Linux and UNIX System Programming Handbook [@kerrisk2010linux]
